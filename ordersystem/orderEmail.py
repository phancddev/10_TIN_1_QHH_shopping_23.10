...
SERVICE_ACCOUNT_FILE = 'client_secret_172252592809-43p59us32915ouoh28kuv7kalul1tnhc.apps.googleusercontent.com.json'
SCOPES = ['https://www.googleapis.com/auth/spreadsheets']

# ID của Google Sheet và phạm vi dữ liệu cần get
SPREADSHEET_ID = '1zWzf4CmLH7WBK8N5DccJDRwD1ZnulGAYdI2TBc34im8'
RANGE_NAME = 'Sheet1!A:J'  # Lấy dữ liệu từ các cột bạn yêu cầu
...
def process_orders():
    ...
    for i, row in enumerate(rows[1:], start=2):
        ...
        delivery_status = row[10] if len(row) > 10 else ''
...
0848829738 (Phú Hùng)"""
            ...
            previous_orders[email] = {'confirmed': False, 'delivered': False}
